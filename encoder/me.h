...
void x264_me_search_ref( x264_t *h, x264_me_t *m, int16_t (*mvc)[2], int i_mvc, int *p_fullpel_thresh, int i_xyoff );
#define x264_me_search( h, m, mvc, i_mvc, i_xyoff )\
    x264_me_search_ref( h, m, mvc, i_mvc, NULL, i_xyoff )
